...
export default function SignUpForm() {
  const [state, formAction, isPending] = useActionState<ActionResult, FormData>(signUpWithCredentials, INITIAL_ACTION_STATE);
        ...
        <div className="form-control">
          <label className="floating-label" htmlFor="signup-password">
            ...
            <div className="input validator w-full">
              ...
              <input id="signup-password" className="w-full placeholder:select-none"
                     type="password"
                     name="password"
                     required
          ...
          >
            {
              isPending ?
                ...
                <span>{ROUTES_NAMES.SIGN_UP}</span>
            }
          </button>
        </div>
      </form>
