...
export default function ThemeController() {
  ...
  useEffect(() => {
    let savedTheme: SavedTheme = null;
    try {
      savedTheme = (typeof window !== 'undefined' ? localStorage.getItem('theme') : null) as SavedTheme;
    } catch {}
    if (savedTheme) {
      setTheme(savedTheme);
  ...
  return (
    <label className="swap swap-rotate">
      ...
      <svg
        className="swap-on h-8 w-8 lg:w-10 lg:h-10 fill-current"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24">
        <path
